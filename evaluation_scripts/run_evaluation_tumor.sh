...
python ../lsf3d/inference/predict_simple.py -i ../litesegformer3d/DATASET_Tumor/litesegformer3d_raw/litesegformer3d_raw_data/Task003_tumor/imagesTs -o ../litesegformer3d/lsf3d/evaluation/litesegformer3d_tumor_checkpoint/inferTs -m 3d_fullres  -t 3 -f 0 -chk model_final_checkpoint -tr litesegformer3d_trainer_tumor
