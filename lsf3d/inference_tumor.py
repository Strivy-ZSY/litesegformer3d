...
def test(fold):
    ...
    path = "lsf3d/inferencedata/labtumor"
    infer_path = "lsf3d/inferencedata/anstumor" # Replace with your generated label file
    
    label_list=sorted(glob.glob(os.path.join(path,'*nii.gz')))
    ...
    if not os.path.exists(file):
        os.makedirs(file)
    fw = open(file+'/dice_five_tumor.txt', 'w')
