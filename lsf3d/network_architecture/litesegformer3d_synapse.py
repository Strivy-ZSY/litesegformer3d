...
class TransformerBlock(nn.Module):
    ...
    def forward(self, x, spatial_shape):
        x = x + self.agbla(self.norm1(x), spatial_shape=spatial_shape)
...
class DecoderHead(nn.Module):
    ...
    def forward(self, c1, c2, c3, c4):
       ############## _MLP decoder on C1-C4 ###########
        ...
        x = torch.nn.functional.interpolate(x, size=(64, 128, 128), mode="trilinear", align_corners=False)
        return x
    ...
    def get_ds_outputs(self, x, _c2, _c3):
        ...
        x2 = torch.nn.functional.interpolate(x2, size=(64, 128, 128), mode="trilinear", align_corners=False)
        
        # Third scale output
        x3 = self.ds_pred_2(_c2)
        x3 = torch.nn.functional.interpolate(x3, size=(64, 128, 128), mode="trilinear", align_corners=False)
