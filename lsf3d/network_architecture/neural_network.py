...
from lsf3d.utilities.random_stuff import no_op
from lsf3d.utilities.to_torch import to_cuda, maybe_to_torch
...
class SegmentationNetwork(NeuralNetwork):
    def __init__(self):
        ...
        # if we have 5 pooling then our patch size must be divisible by 2**5 -> 32
