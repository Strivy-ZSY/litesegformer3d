...
from lsf3d.network_architecture.generic_UNet import Generic_UNet
...
from lsf3d.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from lsf3d.training.loss_functions.dice_loss import DC_and_CE_loss
from lsf3d.training.network_training.network_trainer_tumor import NetworkTrainer_tumor
...
class Trainer_tumor(NetworkTrainer_tumor):
    ...
    def load_plans_file(self):
        ...
        #self.plans = load_pickle("../../../DATASET_Tumor/litesegformer3d_raw/litesegformer3d_raw_data/Task03_tumor/Task003_tumor/litesegformer3d_Plansv2.1_plans_3D.pkl")
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(lsf3d.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="litesegformer3d.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in litesegformer3d.preprocessing" % \
                                               preprocessor_name
