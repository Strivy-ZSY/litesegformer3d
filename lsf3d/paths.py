...
my_output_identifier = "litesegformer3d"
default_plans_identifier = "litesegformer3d_Plansv2.1"
default_data_identifier = 'litesegformer3d_Data_plans_v2.1'
default_trainer = "litesegformer3d_trainer_synapse"

"""
PLEASE READ paths.md FOR INFORMATION TO HOW TO SET THIS UP
"""

base = os.environ['litesegformer3d_raw_data_base'] if "litesegformer3d_raw_data_base" in os.environ.keys() else None
preprocessing_output_dir = os.environ['litesegformer3d_preprocessed'] if "litesegformer3d_preprocessed" in os.environ.keys() else None
network_training_output_dir_base = os.path.join(os.environ['RESULTS_FOLDER']) if "RESULTS_FOLDER" in os.environ.keys() else None

if base is not None:
    nnFormer_raw_data = join(base, "litesegformer3d_raw_data")
    nnFormer_cropped_data = join(base, "litesegformer3d_cropped_data")
    maybe_mkdir_p(nnFormer_raw_data)
    maybe_mkdir_p(nnFormer_cropped_data)
else:
    print("litesegformer3d_raw_data_base is not defined and model can only be used on data for which preprocessed files "
...
if preprocessing_output_dir is not None:
    ...
    print("litesegformer3d_preprocessed is not defined and model can not be used for preprocessing "
