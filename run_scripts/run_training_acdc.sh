...
# train
python lsf3d/run/run_training.py 3d_fullres litesegformer3d_trainer_acdc 1 0

# inference
# python lsf3d/run/run_training.py 3d_fullres litesegformer3d_trainer_acdc 1 0 --valbest --validation_only
