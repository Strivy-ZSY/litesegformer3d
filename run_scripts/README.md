您在运行`BraTS 2017`数据集推理的时候，请将[此处](https://github.com/Strivy-ZSY/litesegformer3d/blob/main/lsf3d/training/network_training/litesegformer3d_trainer_tumor.py)的`splits[self.fold]['val']`的值改为和[nnFormer](https://github.com/282857341/nnFormer/blob/main/nnformer/dataset_json/tumor_dataset.json)统一的数据。
具体代码如下：
```py
